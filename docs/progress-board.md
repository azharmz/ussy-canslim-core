...
Estimated infrastructure/methodology progress: **~94%**.
...
| QQQ/full-M enhancement | OPEN | separate research track; current frozen FWD1 remains SPY-only M proxy |
...
3. Research QQQ/full-M enhancement separately; do not alter frozen FWD1.
4. Research institutional sponsorship I separately if data quality/PIT semantics can be made robust.
