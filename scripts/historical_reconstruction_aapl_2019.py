...
START = date(2019,1,1)
ORACLE = {"pattern":"FLAT_BASE","pivot":221.37,"breakout_date":"2019-09-11","source_breakout_week_ending":"2019-09-13"}
SPLIT_FACTOR = 4.0
ROOT=Path("artifacts/historical-reconstruction/aapl-2019")
...
def main():
    ...
    observed=analyze_security("AAPL",SYMBOL,detector_frame,ASOF)
    ...
    target=[]  # AAPL oracle landmarks are not injected into detector selection; inspect emitted candidates first.
    target_diag=None
    if target:
        seg=target[0]
