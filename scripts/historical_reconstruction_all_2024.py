...
SYMBOL = "ALL"
ASOF = date(2024,4,18)
EXECUTION_END = date(2024,4,19)
START = date(2023,1,1)
ORACLE = {"pattern":"CUP_WITHOUT_HANDLE","pivot":168.05,"breakout_date":"2024-04-18"}
ROOT=Path("artifacts/historical-reconstruction/all-2024")
...
def main():
    ...
    for index_id,ticker in market_ids.items():
        market_raw[index_id]=fetch_yfinance(ticker,date(2023,8,1),ASOF)
    ...
    # ALL has no price-scale transformation in this replay; provider basis is retained unchanged.
    ...
    observed=analyze_security("ALL",SYMBOL,detector_frame,ASOF)
