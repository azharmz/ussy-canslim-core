...
SYMBOL = "AMZN"
ASOF = date(2023,11,17)
EXECUTION_END = date(2023,11,20)
START = date(2023,1,1)
ORACLE = {"pattern":"CUP_WITHOUT_HANDLE","pivot":145.86,"breakout_date":"2023-11-17"}
ROOT=Path("artifacts/historical-reconstruction/amzn-2023")
...
def main():
    ...
    for index_id,ticker in market_ids.items():
        market_raw[index_id]=fetch_yfinance(ticker,date(2023,5,1),ASOF)
    ...
    observed=analyze_security("AMZN",SYMBOL,detector_frame,ASOF)
