...
SYMBOL = "AVTR"
ASOF = date(2021,6,16)
EXECUTION_END = date(2021,6,17)
START = date(2020,6,1)
ORACLE = {"pattern":"CUP_WITHOUT_HANDLE","pivot":33.99,"breakout_date":"2021-06-16"}
ROOT=Path("artifacts/historical-reconstruction/avtr-2021")
...
def main():
    ...
    for index_id,ticker in market_ids.items():
        market_raw[index_id]=fetch_yfinance(ticker,date(2020,9,1),ASOF)
