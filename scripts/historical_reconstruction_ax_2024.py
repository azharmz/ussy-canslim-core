...
START = date(2023,1,1)
ORACLE = {"pattern":"CUP_WITHOUT_HANDLE","pivot":60.00,"breakout_date":"2024-05-06"}
ROOT=Path("artifacts/historical-reconstruction/ax-2024")
...
def main():
    ...
    # AX has no price-scale transformation in this replay; provider basis is retained unchanged.
    ...
    observed=analyze_security("AX",SYMBOL,detector_frame,ASOF)
