...
START = date(2023,1,1)
ORACLE = {"pattern":"CUP_WITHOUT_HANDLE","pivot":787.08,"breakout_date":"2024-05-10"}
ROOT=Path("artifacts/historical-reconstruction/cost-2024")
...
def main():
    ...
    for index_id,ticker in market_ids.items():
        market_raw[index_id]=fetch_yfinance(ticker,date(2023,9,1),ASOF)
    ...
    # COST has no price-scale transformation in this replay; provider basis is retained unchanged.
    ...
    observed=analyze_security("COST",SYMBOL,detector_frame,ASOF)
