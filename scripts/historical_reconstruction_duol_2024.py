...
SYMBOL = "DUOL"
ASOF = date(2024,5,6)
EXECUTION_END = date(2024,5,7)
START = date(2023,5,1)
ORACLE = {"pattern":"CUP_WITH_HANDLE","pivot":241.86,"breakout_date":"2024-05-06"}
ROOT=Path("artifacts/historical-reconstruction/duol-2024")
...
def main():
    ...
    # DUOL has no price-scale transformation in this replay; provider basis is retained unchanged.
    ...
    observed=analyze_security("DUOL",SYMBOL,detector_frame,ASOF)
