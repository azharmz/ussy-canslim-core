...
SYMBOL = "NFLX"
ASOF = date(2024,8,20)
EXECUTION_END = date(2024,8,21)
START = date(2023,1,1)
ORACLE = {"pattern":"CUP_WITHOUT_HANDLE","pivot":697.49,"breakout_date":"2024-08-20"}
ROOT=Path("artifacts/historical-reconstruction/nflx-2024")
...
def main():
    ...
    for index_id,ticker in market_ids.items():
        market_raw[index_id]=fetch_yfinance(ticker,date(2023,12,1),ASOF)
    ...
    observed=analyze_security("NFLX",SYMBOL,detector_frame,ASOF)
    ...
    payload={
      ...
      "price_basis":{"classification":"DATA_ADAPTATION","corporate_action":"LATER_10_FOR_1_SPLIT_RESTORED","price_transform":"x10","volume_transform":"/10","provider_basis_sha256":sha},
