...
SYMBOL = "OLED"
ASOF = date(2019,6,18)
EXECUTION_END = date(2019,6,19)
START = date(2018,6,1)
ORACLE = {"pattern":"CUP_WITH_HANDLE","pivot":177.05,"breakout_date":"2019-06-18"}
ROOT=Path("artifacts/historical-reconstruction/oled-2019")
...
def main():
    ...
    for index_id,ticker in market_ids.items():
        market_raw[index_id]=fetch_yfinance(ticker,date(2019,1,1),ASOF)
    ...
    # OLED has no price-scale transformation in this replay; provider basis is retained unchanged.
    ...
    observed=analyze_security("OLED",SYMBOL,detector_frame,ASOF)
