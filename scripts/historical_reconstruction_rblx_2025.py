...
SYMBOL = "RBLX"
ASOF = date(2025,5,13)
EXECUTION_END = date(2025,5,14)
START = date(2024,5,1)
ORACLE = {"pattern":"CUP_WITH_HANDLE","pivot":74.24,"breakout_date":"2025-05-13"}
ROOT=Path("artifacts/historical-reconstruction/rblx-2025")
...
def main():
    ...
    for index_id,ticker in market_ids.items():
        market_raw[index_id]=fetch_yfinance(ticker,date(2024,11,1),ASOF)
    ...
    # RBLX has no price-scale transformation in this replay; provider basis is retained unchanged.
    ...
    observed=analyze_security("RBLX",SYMBOL,detector_frame,ASOF)
