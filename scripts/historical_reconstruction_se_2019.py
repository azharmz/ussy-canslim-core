...
SYMBOL = "SE"
ASOF = date(2019,11,20)
EXECUTION_END = date(2019,11,21)
START = date(2019,1,1)
ORACLE = {"pattern":"CUP_WITHOUT_HANDLE","pivot":38.10,"breakout_date":"2019-11-20"}
ROOT=Path("artifacts/historical-reconstruction/se-2019")
...
def main():
    ...
    observed=analyze_security("SE",SYMBOL,detector_frame,ASOF)
