...
SYMBOL = "SHOP"
ASOF = date(2025,6,11)
EXECUTION_END = date(2025,6,12)
START = date(2024,6,1)
ORACLE = {"pattern":"CUP_WITH_HANDLE","pivot":112.38,"breakout_date":"2025-06-11"}
ROOT=Path("artifacts/historical-reconstruction/shop-2025")
...
def main():
    ...
    for index_id,ticker in market_ids.items():
        market_raw[index_id]=fetch_yfinance(ticker,date(2024,12,1),ASOF)
    ...
    # SHOP has no price-scale transformation in this replay; provider basis is retained unchanged.
    ...
    observed=analyze_security("SHOP",SYMBOL,detector_frame,ASOF)
