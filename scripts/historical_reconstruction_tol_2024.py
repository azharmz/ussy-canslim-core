...
SYMBOL = "TOL"
ASOF = date(2024,5,15)
EXECUTION_END = date(2024,5,16)
START = date(2023,5,1)
ORACLE = {"pattern":"CUP_WITH_HANDLE","pivot":128.75,"breakout_date":"2024-05-15"}
ROOT=Path("artifacts/historical-reconstruction/tol-2024")
...
def main():
    ...
    # TOL has no price-scale transformation in this replay; provider basis is retained unchanged.
    ...
    observed=analyze_security("TOL",SYMBOL,detector_frame,ASOF)
