...
SYMBOL = "TSLA"
ASOF = date(2020,11,18)
EXECUTION_END = date(2020,11,19)
START = date(2019,10,1)
ORACLE = {"pattern":"CUP_WITH_HANDLE","pivot":466.00,"breakout_date":"2020-11-18"}
ROOT=Path("artifacts/historical-reconstruction/tsla-2020")
...
def main():
    ...
    for index_id,ticker in market_ids.items():
        market_raw[index_id]=fetch_yfinance(ticker,date(2020,5,1),ASOF)
    ...
    # TSLA has no price-scale transformation in this replay; provider basis is retained unchanged.
    ...
    observed=analyze_security("TSLA",SYMBOL,detector_frame,ASOF)
