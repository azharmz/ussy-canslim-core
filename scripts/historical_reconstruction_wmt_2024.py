...
def main():
    ...
    if frame is None or frame.empty:
        raise RuntimeError("WMT historical OHLCV unavailable from Yahoo, Tiingo, and Twelve Data with configured credentials")
    ...
    # WMT replay uses the provider historical basis unchanged.
    ...
    observed=analyze_security("WMT",SYMBOL,detector_frame,ASOF)
