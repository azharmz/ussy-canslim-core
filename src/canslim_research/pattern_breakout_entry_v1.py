...
def decide_pattern_breakout_t1_open(
    *,
    candidate_id: str,
    security_id: str,
    signal_date: date,
    ...
    if candidate_stage != TECHNICAL_ELIGIBLE_STAGE:
        return PatternBreakoutEntry(
            **common, buy_zone_floor=None, buy_zone_ceiling=None,
    ...
    if next_session_date is None or next_open is None:
        return PatternBreakoutEntry(
            **common, buy_zone_floor=floor, buy_zone_ceiling=ceiling,
    ...
    return PatternBreakoutEntry(
        **common, buy_zone_floor=floor, buy_zone_ceiling=ceiling,
        ...
        fill_date=next_session_date if fill is not None else None,
        fill_price=fill,
...
def validate_pattern_breakout_entry(x: PatternBreakoutEntry) -> list[str]:
    ...
    if x.entry_state in {
        EntryState.NOT_TECHNICAL_CANDIDATE,
        EntryState.MISSED_EXTENDED_AT_OPEN,
        EntryState.BELOW_PIVOT_AT_OPEN,
    } and x.fill_price is not None:
